...
/*   Updated: 2024/09/05 18:10:16 by fparis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (vec.x < data->minimap.pos.x || vec.x > data->minimap.pos.x + data->minimap.UI_size
		|| vec.y < data->minimap.pos.y || vec.y > data->minimap.pos.y + data->minimap.UI_size)
		return (0);
	return (1);
}
